...
## 1. De forma interactiva via 'pyspark' (en el nodo master de EMR o en https://hdpssh.dis.eafit.edu.co)
...
## 3. Desde Zeppelin Nodebook:
    ...
    * Entre desde un browser a: https://hdpzeppelin.dis.eafit.edu.co
